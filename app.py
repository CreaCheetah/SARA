...
async def twilio_stream(ws: WebSocket):
    ...
    try:
        while True:
            ...
            # Twilio stuurt JSON met "event": "start" | "media" | "stop"
            # We verwerken hier niets, houden alleen de verbinding open.
            # Voor debug kun je eventueel de events loggen:
            # data = json.loads(msg)
            # print("TWILIO:", data.get("event"))
